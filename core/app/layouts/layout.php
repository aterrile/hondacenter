...
<html>
  <head>
    ...
    <title> <?php echo $settings[1]->val ?>| Panel de Administracion</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"> <?php echo substr($settings[1]->val,0,1); ?> </span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"> <?php echo $settings[1]->val ?> </span>
        </a>
...
<?php endif; ?>
<?php if( (Core::$user->kind==1) || (Core::$user->kind==2) ):?>
            <li><a href="./?view=products"><i class='fa fa-motorcycle'></i> <span> Productos </span> </a></li>
            <?php endif; ?>
   ...
   <?php endif; ?>
    ...
    <?php endif;?>
      ...
      <div class="content-wrapper">
        ...
        <strong>Copyright &copy; 2016 <a href="http://www.daft.cl/" target="_blank">Daft</a></strong>
      </footer>
      <?php else:?>
        <?php if(isset($_GET["view"]) && $_GET["view"]=="clientaccess"):?>
<div class="login-box">
      <div class="login-logo">
        <a href="./"><b>HONDACENTER INVENTARIO</a>
      </div><!-- /.login-logo -->
